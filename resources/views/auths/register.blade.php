        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="{{ route('register.submit') }}" method="POST">
                    ...
                    @csrf
                    <span class="login100-form-title"><b>ĐĂNG KÝ</b></span>
                    @if ($errors->any())
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" placeholder="Họ Tên" name="name" required>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="email" placeholder="Email" name="email" required>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" placeholder="Số điện thoại" name="phone" required>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <input autocomplete="off" class="input100" type="password" placeholder="Xác nhận mật khẩu"
                        name="password_confirmation" id="confirm-password-field" required>
                        <span toggle="#password-field" class="bx fa-fw bx-hide field-icon click-eye"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class='bx bx-key'></i>
                    ...
                    <div class="pt-3 d-flex flex-column gap-3">
                        <button type="submit" id="submit" class="btn btn-success fw-bold w-100 py-2">
                            Đăng ký
                        </button>

                        <a href="{{ route('login') }}" class="btn btn-outline-secondary fw-bold w-100 py-2 text-center mt-2">
                            Quay lại
                        </a>
                    </div>  
                    <!--=====FOOTER======-->
