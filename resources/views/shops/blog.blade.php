    ...
    <section class="blog spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-4.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 16 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-5.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 21 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-6.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 28 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-7.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 16 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-8.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 21 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('shops/img/blog/blog-9.jpg')}}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{asset('shops/img/icon/calendar.png')}}" alt=""> 28 February 2020</span>
                            <h5>Lasik Eye Surgery Are You Ready</h5>
                            <a href="#">Read More</a>
